...
from model_exp1 import GPTConfig, GPT, Muon
...
wandb_project = 'owt'
wandb_run_name = 'hp-exp1-cosine-a3e3-m3e2' # current best-LR anchor
# data
dataset = 'openwebtext'
...
muon_momentum = 0.95 # anchor momentum; exp3 tests 0.90

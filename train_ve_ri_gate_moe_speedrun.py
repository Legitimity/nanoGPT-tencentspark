...
from model_ve_ri_gate_moe_speedrun import GPTConfig, GPT, Muon
...
moe_expert_dim = 1536 # expert intermediate dim (= 2x n_embd; MoE layer then holds exactly 2x the dense FFN params)

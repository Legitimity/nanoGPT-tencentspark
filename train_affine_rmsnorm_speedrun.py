...
from model_affine_rmsnorm_speedrun import GPTConfig, GPT, Muon

# -----------------------------------------------------------------------------
# default config values designed to train a gpt2 (124M) on OpenWebText
# I/O
out_dir = 'out-affine-rmsnorm-speedrun'
...
wandb_project = 'owt'
wandb_run_name = 'crz affine-rmsnorm-lr3e3-muon3e2-mom09-4h'
# data
dataset = 'openwebtext'
...
block_size = 1024
# model
structure_variant = 'affine_rmsnorm'
n_layer = 12
n_head = 12
n_embd = 768
...
if structure_variant != 'affine_rmsnorm':
    raise ValueError("structure_variant must remain 'affine_rmsnorm'")
